...
require 'textile_to_markdown/convert_redmine'
...
class ConvertRedmineTest < ActiveSupport::TestCase
  ...
  test "should convert redmine" do
    ...
    @textile = IO.read File.join(File.dirname(__FILE__), "../fixtures/test.textile")
    @md = IO.read File.join(File.dirname(__FILE__), "../fixtures/test.md")
